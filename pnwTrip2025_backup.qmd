  ...
  pdf:
    ...
    include-in-header:
      - text: |
          ...
          % Make two-columns class work properly in PDF
          \newenvironment{two-columns}{\begin{multicols}{2}}{\end{multicols}}
